...
$is_edit = !empty($_GET['id']); // flag for edit mode
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $password   = !empty($_POST["password"]) ? sha1(test_input($_POST["password"])) : "";
...
?>
<table border="1">
    <th>ID</th><th>Username</th><th>Firstname</th><th>Middlename</th>
    <th>Lastname</th><th>Gender</th><th>Date of Birth</th><th>Email Address</th>
    <th>Status</th><th>Type</th><th>Date Created</th><th>Date Updated</th><th>Action</th>
    <?php
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]). ($is_edit ? '?id=' . intval($_GET['id']) : ''); ?>" method="POST">
    ...
    Status: <input type="number" value="<?php echo $status;?>" name="status" max="11" min="0" required><br/>
    Type: <input type="number" value="<?php echo $type;?>" name="type" max="11" min="0" required><br/><br/>
    <input type="submit" value="<?php echo $is_edit ? 'Update Record' : 'Add Record'; ?>" />
</form>
